...
class Config(object):
    ...
    OWNER_ID = 6708139114  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    ...
    JOIN_LOGGER =  -1001897401408 #Prints any new group the bot is added to, prints just the name and ID.
    REM_BG_API_KEY = "dxsh728mZMDmj4ijSZCNPZig"
    EVENT_LOGS = -1001897401408 #Prints information like gbans, sudo promotes, AI enabled disable states that may help in debugging and shit
    LOAD = []
